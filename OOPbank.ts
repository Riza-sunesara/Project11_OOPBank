...
class Customer {
    ...
    constructor(FirstName:string,LastName:string,Gender:string,Age:number,MobileNumber:number,bankacc:number) {
...
class BankAccount implements IBankAccount{
    ...
    Add_Cust(bobj:Customer){
        this.cust.push(bobj)
    }
    Add_accno(accobj:IBankAccount){
        this.account.push(accobj);
    }
    Debit(amount: number,accno:IBankAccount): string {
    ...
    Credit(amount: number,accno:IBankAccount): string {
